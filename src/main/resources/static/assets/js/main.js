...
$(document).ready(function() {
    ...
    $(".countdown")
        .countdown("2020/05/28", function(event) {
            $(this).html(
                event.strftime('<div>%D <span>Jours</span></div>  <div>%H<span>Heures</span></div> <div>%M<span>Minutes</span></div> <div>%S<span>Secondes</span></div>')
            );
        });
