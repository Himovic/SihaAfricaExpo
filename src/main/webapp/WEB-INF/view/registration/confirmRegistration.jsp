...
<section class="pt100 pb100">
	<c:set var="exhibitorSaveSuccess" value="${exhibitorSaveSuccess}" />
	...
	<div class="container">
		<div style="margin-bottom: 0;" class="section_title">
            <h3 style="text-transform: none;color: #1f1039;" class="title">
                <c:if test = "${exhibitorSaveSuccess=='exhibitorSaveSuccess'}">
					Votre réservation au Salon Saidalya, qui aura lieu les 22, 23 et 24 octobre 2020 
					, à l'Hôtel Marriott de Constantine a été éffectué avec succées.
				</c:if>
				<c:if test = "${bTobSaveSuccess=='bTobSaveSuccess'}">
					Votre réservation au B2B au Salon Saidalya, qui aura lieu les 22, 23 et 24 octobre 2020 
					, à l'Hôtel Marriott de Constantine a été éffectué avec succées.
				</c:if>
            </h3>
        </div>
        <div style="color: #000;" class="row">
            ...
            <div class="col-md-6">
            	<p>Nous vous avons transmis un email, dans lequel vous trouverez, en piéce jointe, 
            	votre Bon de commande, ainsi que le lien pour pouvoir nous envoyer une copie de votre 
            	ordre de virement (au plus tard dans les 48 heures qui suivent).</p>
            </div>
        </div>
	</div>
</section>
