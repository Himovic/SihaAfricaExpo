...
<section class="pt100 pb100">
	<div class="container">
        ...
        <%
    		...
    		String companyName = (String) currentSession.getAttribute("company");
        %>
        <div style="color: #000;" class="row">
            <div class="ml-auto text-auto">
            ...
            <div class="col-md-6">
                <form method="POST" action="/sendPaiement" enctype="multipart/form-data">
            ...
            <div class="col-md-6">
            	<img src="/assets/img/paiement.jpg" alt="Paiement" />
            </div>
        </div>
	</div>
</section>
