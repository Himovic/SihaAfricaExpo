...
<head>
    ...
    <!-- ========== Title ========== -->
    <title>Réservation chambre Double à l'Ibis</title>
    <!-- ========== Favicon Ico ========== -->
	...
	<div class="container">
		<div class="section_title">
            ...
            <h3 style="text-transform: none;color: #1f1039;" class="title">
                Réservation d'une chambre Double à l'Ibis
            </h3>
        </div>
        <c:if test = "${success=='success'}">
			<div class="alert alert-success" role="alert">
  				...
  				meilleurs délais. Si vous souhaitez réserver encore une chambre double a l'Ibis 
  				veuillez remplir ce formulaire.
			</div>
		</c:if>
        <div class="row">
			<div class="col-md-6">
				<form action="/regIbisDouble" method="POST">
