	...
	<div class="container">
		<div class="section_title">
            <h3 style="text-transform: none;color: #1f1039;" class="title">
                Réservation d'une chambre Double au Marriott
            </h3>
        </div>
        ...
        <c:if test = "${success=='success'}">
			<div class="alert alert-success" role="alert">
  				...
  				meilleurs délais. Si vous souhaitez réserver encore une chambre double au Marriott 
  				veuillez remplir ce formulaire.
			</div>
		</c:if>
        <div class="row">
			<div class="col-md-6">
				<form action="/regMarriottDouble" method="POST">
				...
				<div class="form-group">
					...
					<input type="text" value="Chambre Double Avec petit déjeuner, pour deux personnes" class="form-control" name="roomingType" id="roomingType" readonly="true"/> 
				</div>
				<div class="form-group">
