...
<head>
    ...
    <!-- ========== Title ========== -->
    <title>Réservation chambre Double au Marriott</title>
    <!-- ========== Favicon Ico ========== -->
	...
	<div class="container">
		<div class="section_title">
            <h3 style="text-transform: none;color: #1f1039;" class="title">
                Réservation d'une chambre Triple au Novotel
            </h3>
        </div>
        ...
        <c:if test = "${success=='success'}">
			<div class="alert alert-success" role="alert">
  				...
  				meilleurs délais. Si vous souhaitez réserver encore une chambre triple au Novotel
  				veuillez remplir ce formulaire.
			</div>
		</c:if>
        <div class="row">
			<div class="col-md-6">
				<form action="/regNovotelTriple" method="POST">
				<div class="form-group">
					<label for="clientsNameFirst">Nom et Prénom de la 1ère personne</label>
					<input type="text" class="form-control" name="clientsNameFirst" id="clientsNameFirst" required="required" /> 
				</div>
				<div class="form-group">
					<label for="clientsNameSecond">Nom et Prénom de la 2ème personne</label>
					<input type="text" class="form-control" name="clientsNameSecond" id="clientsNameSecond" required="required" /> 
				</div>
				<div class="form-group">
					<label for="clientsNameThird">Nom et Prénom de la 3ème personne</label>
					<input type="text" class="form-control" name="clientsNameThird" id="clientsNameThird" required="required" /> 
				</div>
				<div class="form-group">
				...
				<div class="form-group">
					...
					<input type="text" value="Chambre Triple Avec petit déjeuner, pour trois personnes" class="form-control" name="roomingType" id="roomingType" readonly="true"/> 
				</div>
				<div class="form-group">
